...
def main(args):
    ...
    exec("from emd_utils import %s" % args.model)
    model = eval(args.model)

    ot.tic()
    bary, obj = model(data, M, args.n, args.d)
    time = ot.toc('')
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument('-d', type=str, default=4, help='Number of dists')
    ...
    arg_parser.add_argument('--outfile', type=str, default='res/tmp_1d_results.csv', help='results file to print to')
